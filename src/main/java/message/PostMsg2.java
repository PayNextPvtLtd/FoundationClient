...
public class PostMsg2
{
    ...
    ConcurrentHashMap<String, String> trans_obj;

    public PostMsg2()
    {
        trans_obj=new ConcurrentHashMap<>();
    }
    ...
    public boolean parseMsgFromRemote(String msg_from_remote)
    {
        ...
        trans_obj = parseAmpString(msg_from_remote);
    ...
    public boolean setMsgType(String value)
    {
        ...
        trans_obj.remove(fieldName);

        trans_obj.put(fieldName, value);
    ...
    {
        String fieldName = Field._MTI;
        return (String) trans_obj.get(fieldName);
    }
    ...
    public String getCardType()
    {
        ...
        String value = (String) trans_obj.get(fieldName);
    ...
    public String getMsg()
    {
        ...
        for (int i = 2; i < 120; i++)
        {
            ...
            {
                str = str + "F"
                        + FormatData.resize(Integer.toString(i), 3, "0", false)
                        + "=" + getField(i) + "&";
            }
        }
        ...
        for (int i = 2; i < 129; i++)
        {
            ...
            if (i == 2 || i == 35 || i == 45 || i == 52 || i == 53 || i == 55)
            {
                if (value != null && value.trim().length() > 0)
                {
                    str = str
                            + "\t[F"
                            + FormatData.resize(Integer.toString(i), 3, "0",
                                    false) + "] = ["

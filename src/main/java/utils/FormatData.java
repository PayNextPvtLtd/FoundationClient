...
public final class FormatData
{
    ...
    /**
     * Return true if the string is alphanum.<code>{letter digit (.) (_) (-) ( ) (?) }</code>
     * @param s
     * @return 
     */
    ...
    /**
     * Using this in Android will require special permissions because of Streams
     * 
     * @param connurl
     * @param timeout
     * @param request
